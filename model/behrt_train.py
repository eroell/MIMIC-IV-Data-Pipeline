...
#             "max_position_embedding": train_params[
#                 "max_len_seq"
...
#         TrainDset = DataLoader(
#             train_data, max_len=train_params["max_len_seq"], code="code"
#         )
#         trainload = torch.utils.data.DataLoader(
#             dataset=TrainDset, batch_size=train_params["batch_size"], shuffle=True
#         )
#         ValDset = DataLoader(val_data, max_len=train_params["max_len_seq"], code="code")
#         valload = torch.utils.data.DataLoader(
#             dataset=ValDset, batch_size=train_params["batch_size"], shuffle=True
#         )

#         train_loss, val_loss = train(trainload, valload, train_params["device"])

#         behrt.load_state_dict(
#             torch.load(
#                 "./saved_models/checkpoint/behrt", map_location=train_params["device"]
#             )
#         )
#         print("Loading succesfull")

#         TestDset = DataLoader(
#             test_data, max_len=train_params["max_len_seq"], code="code"
#         )
#         testload = torch.utils.data.DataLoader(
#             dataset=TestDset, batch_size=train_params["batch_size"], shuffle=True
#         )
...
#                 train_loss = train_loss / math.ceil(
#                     (train_params["train_data_len"] / train_params["batch_size"])
#                 )
#                 val_loss = val_loss / math.ceil(
#                     (train_params["val_data_len"] / train_params["batch_size"])
#                 )
...
#                     save_model(
#                         model_to_save.state_dict(), "./saved_models/checkpoint/behrt"
#                     )
#                     best_val = val_loss
...
#                         pd.DataFrame(logits.detach().cpu().numpy()).to_csv(
#                             f, header=False
#                         )
#                     with open("./data/behrt/behrt_labels.csv", "a") as f:
#                         pd.DataFrame(labels.detach().cpu().numpy()).to_csv(
#                             f, header=False
#                         )
